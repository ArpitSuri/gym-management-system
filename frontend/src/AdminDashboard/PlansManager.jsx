...
// import { Plus, Edit3, Trash2, Eye,  Package, FileText, Save, X, CheckCircle, AlertCircle, IndianRupee } from 'lucide-react';
                                                    ...
                                                    >
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <div className="text-green-400 font-semibold flex items-center">
                                                                <IndianRupee className="w-4 h-4 mr-1" />{plan.price.toFixed(2)}
                                                            </div>
                                                        </td>
                                                        <td className="px-6 py-4">
                                                            <div className="text-gray-400 text-sm truncate max-w-xs">
                                        ...
                                        <div className="flex items-start justify-between mb-4">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-green-400 flex items-center">
                                                    <IndianRupee className="w-5 h-5 mr-1" />{plan.price.toFixed(2)}
                                                </p>
                                            </div>
                                            <Package className="w-8 h-8 text-blue-400" />
                                        </div>
